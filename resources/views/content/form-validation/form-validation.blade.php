    ...
    <div class="card">
      ...
      <div class="card-body">
        <form class="browser-default-validation">
          ...
          <div class="form-floating form-floating-outline mb-4">
            <input type="date" class="form-control flatpickr-validation" placeholder="YYYY-MM-DD" id="basic-default-dob" required />
    ...
    <div class="card">
      ...
      <div class="card-body">
        <form class="needs-validation" novalidate>
          ...
          <div class="form-floating form-floating-outline mb-4">
            <input type="date" class="form-control flatpickr-validation" placeholder="YYYY-MM-DD" id="bs-validation-dob" required />
