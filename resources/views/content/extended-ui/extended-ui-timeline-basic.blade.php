...
<div class="row">
  ...
  <div class="col-xl-6 mb-4 mb-xl-0">
    <div class="card">
      <h5 class="card-header pb-4">Basic Timeline</h5>
            ...
            <div class="timeline-event">
              ...
              <div class="d-flex justify-content-between flex-wrap mb-2">
                <div>
                  ...
                  <span class="d-inline-flex scaleX-n1-rtl align-middle"><i class="mdi mdi-arrow-right mx-3"></i></span>
              ...
              <div class="d-flex align-items-center">
                <img src="{{ asset('assets//img/icons/mis')}}c/pdf.png" alt="img" width="28" class="me-2">
          ...
          <li class="timeline-item timeline-item-transparent">
            ...
            <div class="timeline-event">
              <div class="d-flex flex-sm-row flex-column">
                <img src="{{ asset('assets/img/elements/16.jpg')}}" class="rounded me-3" alt="Shoe img" height="62" width="62" />
                <div>
            ...
            <div class="timeline-event">
              ...
              <div class="d-flex justify-content-between flex-wrap gap-2">
                ...
                <div class="d-flex flex-wrap align-items-center cursor-pointer">
                  <i class="mdi mdi-message-outline me-4"></i>
  ...
  <div class="col-xl-6 mb-4 mb-xl-0">
    <div class="card">
      <h5 class="card-header pb-4">Timeline Outlined</h5>
      <div class="card-body pb-0">
        <ul class="timeline timeline-outline mb-0">
          <li class="timeline-item timeline-item-transparent border-left-dashed">
            ...
            <div class="timeline-event">
              ...
              <div class="d-flex justify-content-between flex-wrap mb-2">
                <div>
                  ...
                  <span class="d-inline-flex scaleX-n1-rtl align-middle">
                    <i class="mdi mdi-arrow-right mx-3"></i>
                  </span>
                  <span>Heathrow Airport, London</span>
                </div>
                <div>
              ...
              <div class="d-flex align-items-center">
                <img src="{{ asset('assets//img/icons/misc/pdf.png')}}" alt="img" width="28" class="me-2">
                <span class="h6 mb-0">booking-card.pdf</span>
              </div>
            </div>
          </li>
