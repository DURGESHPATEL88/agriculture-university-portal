        ...
        <div class="d-flex align-items-start justify-content-between">
          <div class="content-left">
            ...
            <div class="d-flex align-items-end mt-2">
              <h4 class="mb-2 me-1 display-6">{{$totalUser}}</h4>
              <small class="text-success mb-2">(100%)</small>
            </div>
      ...
      <div class="card-body">
        <div class="d-flex align-items-start justify-content-between">
          <div class="content-left">
            ...
            <div class="d-flex align-items-end mt-2">
              <h4 class="mb-2 me-1 display-6">{{$verified}}</h4>
              <small class="text-success mb-2">(+95%)</small>
            </div>
      ...
      <div class="card-body">
        <div class="d-flex align-items-start justify-content-between">
          <div class="content-left">
            ...
            <div class="d-flex align-items-end mt-2">
              <h4 class="mb-2 me-1 display-6">{{$userDuplicates}}</h4>
              <small class="text-success mb-2">(0%)</small>
            </div>
            <small>Recent analytics</small>
          </div>
  ...
  <div class="col-sm-6 col-xl-3">
    <div class="card">
      <div class="card-body">
        <div class="d-flex align-items-start justify-content-between">
          <div class="content-left">
            <p class="text-heading mb-2">Verification Pending</p>
            <div class="d-flex align-items-end mt-2">
              <h4 class="mb-2 me-1 display-6">{{$notVerified}}</h4>
              <small class="text-danger mb-2">(+6%)</small>
            </div>
            <small>Recent analytics</small>
          </div>
          <span class="badge bg-label-warning rounded p-2">
            <i class="mdi mdi-account-circle-outline mdi-20px"></i>
          </span>
        </div>
      </div>
    </div>
