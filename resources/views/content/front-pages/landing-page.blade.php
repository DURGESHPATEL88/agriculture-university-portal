        ...
        <div class="col-lg-7">
          <div class="accordion" id="accordionFront">
            ...
            <div class="accordion-item">
              ...
              <div id="accordionTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionFront">
                <div class="accordion-body">
            ...
            <div class="accordion-item active">
              ...
              <div id="accordionThree" class="accordion-collapse collapse show" aria-labelledby="headingThree" data-bs-parent="#accordionFront">
                <div class="accordion-body">
            ...
            <div class="accordion-item">
              ...
              <div id="accordionFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionFront">
                <div class="accordion-body">
            ...
            <div class="accordion-item">
              ...
              <div id="accordionFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#accordionFront">
                <div class="accordion-body">
        ...
        <div class="col-lg-5">
          <div class="card h-100">
            <div class="bg-primary rounded text-white card-body">
              ...
              <img src="{{asset('assets/img/front-pages/landing-page/let’s-contact.png')}}" alt="let’s contact" class="w-100 mb-2 pb-1" />
              <p class="mb-0">
