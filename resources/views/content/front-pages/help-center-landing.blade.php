...
<section class="section-py first-section-pt help-center-header">
  <h1 class="text-center text-primary display-6 fw-semibold">Hello, how can we help?</h1>
  <div class="input-wrapper my-3 input-group input-group-lg input-group-merge position-relative mx-auto">
    ...
    <input type="text" class="form-control h-px-40" placeholder="Search" aria-label="Search" aria-describedby="basic-addon1" />
  </div>
...
<section class="section-py">
  <div class="container">
    <h4 class="display-6 text-center mb-4 pb-md-2">Popular Articles</h4>
    <div class="row">
...
<section class="section-py bg-body">
  <div class="container">
    <h4 class="display-6 text-center mb-4 pb-md-2">Knowledge Base</h4>
    <div class="row">
      <div class="col-lg-10 mx-auto">
        <div class="row">
            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <span class="badge bg-label-primary p-2 rounded me-2"><i class="tf-icons mdi mdi-cart-plus mdi-20px"></i></span>
                ...
                <ul class="list-unstyled my-4">
                  <li class="mb-2">
                    <a href="{{url('front-pages/help-center-article')}}" class="text-heading d-flex justify-content-between align-items-center">
                      ...
                      <i class="tf-icons mdi mdi-chevron-right mdi-24px scaleX-n1-rtl text-muted"></i>
                    </a>
                  </li>
                  <li class="mb-2">
                    <a href="{{url('front-pages/help-center-article')}}" class="text-heading d-flex justify-content-between align-items-center">
          ...
          <div class="col-md-4 col-ms-6 mb-4">
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <span class="badge bg-label-primary p-2 rounded me-2"><i class="tf-icons mdi mdi-face-agent mdi-20px"></i></span>
          ...
          <div class="col-md-4 col-ms-6 mb-4">
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <span class="badge bg-label-primary p-2 rounded me-2"><i class="tf-icons mdi mdi-currency-usd mdi-20px"></i></span>
          ...
          <div class="col-md-4 col-ms-6 mb-4">
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <span class="badge bg-label-primary p-2 rounded me-2"><i class="tf-icons mdi mdi-format-color-fill mdi-20px"></i></span>
          ...
          <div class="col-md-4 col-ms-6 mb-4">
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <span class="badge bg-label-primary p-2 rounded me-2"><i class="tf-icons mdi mdi-lock-open-outline mdi-20px"></i></span>
          ...
          <div class="col-md-4 col-ms-6 mb-4">
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <span class="badge bg-label-primary p-2 rounded me-2"><i class="tf-icons mdi mdi-account-outline mdi-20px"></i></span>
...
<section class="section-py">
  <div class="container">
    <h4 class="display-6 text-center mb-4 pb-md-2">Keep Learning</h4>
    <div class="row">
      <div class="col-lg-10 mx-auto">
        <div class="row gy-4 gy-md-0">
          <div class="col-md-4">
            <div class="card border shadow-none">
              <div class="card-body text-center">
                ...
                <p>Expert tips and tools to improve your website or online store using our blog.</p>
