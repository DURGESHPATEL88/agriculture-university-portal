    ...
    <div class="tab-content p-0">
      ...
      <div class="tab-pane fade show active" id="store_details" role="tabpanel">
        ...
        <div class="card mb-4">
          <div class="card-header">
            <div class="card-title mb-0">
              <h5 class="mb-1">Time zone and units of measurement</h5>
              <p class="text-body mb-0">Used to calculate product prices, shipping weighs, and order times.</p>
            </div>
          </div>
          <div class="card-body">
            <div class="row g-4">
        ...
        <div class="card mb-4">
          <div class="card-header">
            <div class="card-title mb-0">
              <h5 class="mb-1">Store currency</h5>
        ...
        <div class="card mb-4">
          <div class="card-header">
            <div class="card-title mb-0">
              <h5 class="mb-1">Order id format</h5>
        ...
        <div class="d-flex justify-content-end gap-3">
          ...
          <a class="btn btn-primary" href="{{url('/app/ecommerce/settings/payments')}}">Save</a>
        </div>
