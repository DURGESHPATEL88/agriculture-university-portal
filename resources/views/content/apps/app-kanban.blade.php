        ...
        <div class="tab-pane fade" id="tab-activity" role="tabpanel">
          <div class="media mb-4 d-flex align-items-center">
            ...
            <div class="media-body ms-1">
              <h6 class="mb-0">Jordan Left the board.</h6>
          ...
          <div class="media mb-4 d-flex align-items-center">
            ...
            <div class="media-body ms-1">
              <h6 class="mb-0">Dianna mentioned <span class="text-primary">@bruce</span> in a comment.</h6>
          ...
          <div class="media mb-4 d-flex align-items-center">
            ...
            <div class="media-body ms-1">
              <h6 class="mb-0">Martian added moved
                Charts & Maps task to the done board.</h6>
          ...
          <div class="media mb-4 d-flex align-items-center">
            ...
            <div class="media-body ms-1">
              <h6 class="mb-0">Barry Commented on App
                review task.</h6>
          ...
          <div class="media mb-4 d-flex align-items-center">
            ...
            <div class="media-body ms-1">
              <h6 class="mb-0">Bruce was assigned
                task of code review.</h6>
          ...
          <div class="media mb-4 d-flex align-items-center">
            ...
            <div class="media-body ms-1">
              <h6 class="mb-0">Clark assigned task UX
                Research to <span class="text-primary">@martian</span></h6>
          ...
          <div class="media mb-4 d-flex align-items-center">
            ...
            <div class="media-body ms-1">
              <h6 class="mb-0">Ray Added moved
                <span class="text-heading">Forms & Tables</span> task
                from in progress to done.</h6>
          ...
          <div class="media mb-4 d-flex align-items-center">
            ...
            <div class="media-body ms-1">
              <h6 class="mb-0">Barry Complete all the
                tasks assigned to him.</h6>
          ...
          <div class="media mb-4 d-flex align-items-center">
            ...
            <div class="media-body ms-1">
              <h6 class="mb-0">Jordan added task to
                update new images.</h6>
          ...
          <div class="media mb-4 d-flex align-items-center">
            ...
            <div class="media-body ms-1">
              <h6 class="mb-0">Dianna moved task
                <span class="fw-medium text-heading">FAQ UX</span> from in
                progress to done board.</h6>
              <small class="text-muted">Today 7:00 AM</small>
            </div>
          </div>
          <div class="media mb-4 d-flex align-items-center">
            ...
            <div class="media-body ms-1">
              <h6 class="mb-0">Clark added new board
                with name <span class="fw-medium text-heading">Done</span></h6>
          ...
          <div class="media d-flex align-items-center">
            ...
            <div class="media-body ms-1">
              <h6 class="mb-0">Bruce added new task
                in progress board.</h6>
