    ...
    <div class="col-lg-8">
      <div class="d-flex justify-content-between align-items-center flex-wrap mb-2 gap-1">
        ...
        <div class="d-flex align-items-center">
          ...
          <i class='mdi mdi-share-variant mdi-24px mx-4'></i>
      ...
      <div class="card academy-content shadow-none border">
        ...
        <div class="card-body">
          ...
          <div class="d-flex flex-wrap">
            <div class="me-5">
              <p class="text-nowrap"><i class='mdi mdi-check mdi-24px me-2'></i>Skill level: All Levels</p>
              <p class="text-nowrap"><i class='mdi mdi-account-outline mdi-24px me-2'></i>Students: 38,815</p>
            ...
            <div>
              ...
              <p class="text-nowrap "><i class='mdi mdi-timer-outline mdi-24px me-2'></i>Video: 1.5 total hours</p>
            </div>
          </div>
          <hr class="mb-4 mt-2">
          <h5>Description</h5>
          ...
          <div class="d-flex justify-content-start align-items-center user-name">
            <div class="avatar-wrapper">
              <div class="avatar avatar-sm me-2"><img src="{{asset('assets/img/avatars/1.png')}}" alt="Avatar" class="rounded-circle"></div>
            </div>
