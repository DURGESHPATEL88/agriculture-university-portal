    ...
    <div class="row g-0">
      ...
      <div class="col app-email-sidebar border-end flex-grow-0" id="app-email-sidebar">
        <div class="btn-compost-wrapper">
          <button class="btn btn-primary btn-compose w-100" data-bs-toggle="modal" data-bs-target="#emailComposeSidebar">Compose</button>
        </div>
        <!-- Email Filters -->
      ...
      <div class="col app-email-view flex-grow-0 bg-lightest" id="app-email-view">
        <div class="card-body app-email-view-header p-3 py-2">
          ...
          <div class="d-flex justify-content-between align-items-center py-2">
            <div class="d-flex align-items-center overflow-hidden">
              <span class="btn btn-icon btn-text-secondary rounded-pill btn-sm">
                <i class="mdi mdi-chevron-left mdi-20px cursor-pointer text-heading" data-bs-toggle="sidebar" data-target="#app-email-view"></i>
              </span>
              <h6 class="text-truncate mb-0 ms-2 me-3 pe-1 fw-normal">Focused impactful open issues</h6>
        ...
        <div class="app-email-view-content py-4">
          <p class="email-earlier-msgs text-center cursor-pointer mb-5">1 Earlier Message</p>
          ...
          <div class="card email-card-prev mx-sm-4 mx-3 border">
            <div class="card-header d-flex justify-content-between align-items-center flex-wrap border-bottom">
              ...
              <div class="d-flex align-items-center">
                ...
                <i class="email-list-item-bookmark mdi mdi-star-outline mdi-20px cursor-pointer me-2"></i>
          ...
          <div class="card email-card-last mx-sm-4 mx-3 mt-3">
            <div class="card-header d-flex justify-content-between align-items-center flex-wrap border-bottom">
              <div class="d-flex align-items-center mb-sm-0 mb-3">
          ...
          <div class="email-reply card mt-3 mx-sm-4 mx-3 mb-3 mb-md-0 border">
  ...
  <div class="app-email-compose modal" id="emailComposeSidebar" tabindex="-1" aria-labelledby="emailComposeSidebar" aria-hidden="true">
    <div class="modal-dialog m-0 me-md-4 mb-4 modal-lg">
      <div class="modal-content p-0">
        <div class="modal-header bg-lightest py-3">
          <h6 class="modal-title text-body">Compose Mail</h6>
        ...
        <div class="modal-body flex-grow-1 pb-sm-0 p-4 py-2">
          <form class="email-compose-form">
            ...
            <div class="email-compose-bcc d-none">
              <hr class="container-m-nx my-2">
              <div class="d-flex align-items-center">
                <label for="email-bcc" class="form-label mb-0 fw-6 text-muted">Bcc:</label>
            ...
            <div class="email-compose-message container-m-nx">
              <div class="d-flex justify-content-end">
                <div class="email-editor-toolbar border-0 border-top w-100">
                  <span class="ql-formats me-0">
                    <button class="ql-bold"></button>
                    <button class="ql-italic"></button>
                    <button class="ql-underline"></button>
