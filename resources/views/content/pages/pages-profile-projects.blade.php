    ...
    <div class="card">
      ...
      <div class="card-body border-top">
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="ms-auto">
            <a href="javascript:void(0);" class="text-muted d-flex align-items-center"><i class="mdi mdi-message-outline mdi-24px me-2"></i> 236</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card">
      ...
      <div class="card-body border-top">
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="ms-auto">
            <a href="javascript:void(0);" class="text-muted d-flex align-items-center"><i class="mdi mdi-message-outline mdi-24px me-2"></i> 98</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card">
      ...
      <div class="card-body border-top">
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="ms-auto">
            <a href="javascript:void(0);" class="text-muted d-flex align-items-center"><i class="mdi mdi-message-outline mdi-24px me-2"></i> 120</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card">
      ...
      <div class="card-body border-top">
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="ms-auto">
            <a href="javascript:void(0);" class="text-muted d-flex align-items-center"><i class="mdi mdi-message-outline mdi-24px me-2"></i> 20</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card">
      ...
      <div class="card-body border-top">
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="ms-auto">
            <a href="javascript:void(0);" class="text-muted d-flex align-items-center"><i class="mdi mdi-message-outline mdi-24px me-2"></i> 16</a>
          </div>
        </div>
      </div>
    </div>
