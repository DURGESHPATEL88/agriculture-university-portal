          ...
          <div class="card-body">
            <form id="formAccountSettingsApiKey" method="POST" onsubmit="return false">
              <div class="row gy-3">
                ...
                <div class="col-12">
                  <button type="submit" class="btn btn-primary me-2">Create Key</button>
                </div>
              </div>
            </form>
          </div>
          ...
          <div class="col-md-12">
            <div class="bg-lighter rounded p-3 mb-3">
              ...
              <div class="d-flex align-items-center mb-2">
                <span class="me-2 fw-medium">23eaf7f0-f4f7-495e-8b86-fad3261282ac</span>
            ...
            <div class="bg-lighter rounded p-3 mb-3">
              ...
              <div class="d-flex align-items-center mb-2">
                <span class="me-2 fw-medium">bb98e571-a2e2-4de8-90a9-2e231b5e99</span>
                <span class="text-light cursor-pointer"><i class="mdi mdi-content-copy"></i></span>
              </div>
            ...
            <div class="bg-lighter rounded p-3">
              ...
              <div class="d-flex align-items-center mb-2">
                <span class="me-2 fw-medium">2e915e59-3105-47f2-8838-6e46bf83b711</span>
                <span class="text-light cursor-pointer"><i class="mdi mdi-content-copy"></i></span>
              </div>
