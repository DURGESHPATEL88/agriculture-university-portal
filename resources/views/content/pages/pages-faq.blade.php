...
<div class="faq-header d-flex flex-column justify-content-center align-items-center">
  <h3 class="text-center text-primary mb-2"> Hello, how can we help? </h3>
  <p class="text-body text-center mb-0 px-3">or choose a category to quickly find the help you need</p>
  <div class="input-wrapper my-3 input-group input-group-lg input-group-merge px-sm-5">
      ...
      <ul class="nav nav-align-left nav-pills flex-column flex-nowrap">
        ...
        <li class="nav-item">
          <button class="nav-link" data-bs-toggle="tab" data-bs-target="#orders">
            <i class="mdi mdi-wallet-giftcard me-2"></i>
