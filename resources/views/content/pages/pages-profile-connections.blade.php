    ...
    <div class="card">
      <div class="card-body text-center">
        ...
        <div class="d-flex align-items-center justify-content-around mb-4">
          ...
          <div>
            <h5 class="mb-1">834</h5>
            <span>Tasks</span>
          </div>
          <div>
            <h5 class="mb-1">129</h5>
  ...
  <div class="col-xl-4 col-lg-6 col-md-6">
    <div class="card">
      <div class="card-body text-center">
        ...
        <div class="d-flex align-items-center justify-content-around mb-4">
          <div>
            <h5 class="mb-1">112</h5>
            <span>Projects</span>
          </div>
          <div>
            <h5 class="mb-1">23.1k</h5>
            <span>Tasks</span>
          </div>
          <div>
            <h5 class="mb-1">1.28k</h5>
            <span>Connections</span>
          </div>
        </div>
        <div class="d-flex align-items-center justify-content-center">
  ...
  <div class="col-xl-4 col-lg-6 col-md-6">
    <div class="card">
      <div class="card-body text-center">
        ...
        <div class="d-flex align-items-center justify-content-around mb-4">
          <div>
            <h5 class="mb-1">244</h5>
            <span>Projects</span>
          </div>
          <div>
            <h5 class="mb-1">23.8k</h5>
            <span>Tasks</span>
          </div>
          <div>
            <h5 class="mb-1">2.14k</h5>
            <span>Connections</span>
          </div>
        </div>
        <div class="d-flex align-items-center justify-content-center">
