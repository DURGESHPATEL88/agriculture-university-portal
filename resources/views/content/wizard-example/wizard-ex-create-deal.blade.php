                ...
                <div class="form-check custom-option custom-option-icon">
                  <label class="form-check-label custom-option-content" for="customRadioPercentage">
                    <span class="custom-option-body">
                      <i class='mdi mdi-tag-outline text-body'></i>
      ...
      <div id="review-complete" class="content">
        <div class="row g-3">
          ...
          <div class="col-lg-6 d-flex align-items-center justify-content-center border rounded-3 pt-3">
            <img class="img-fluid" src="{{asset('assets/img/illustrations/create-deal-review-complete.png')}}" alt="process completed" width="170" />
          </div>
