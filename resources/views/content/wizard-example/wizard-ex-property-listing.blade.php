    ...
    <form id="wizard-property-listing-form" onSubmit="return false">
                ...
                <div class="form-check custom-option custom-option-icon">
                  <label class="form-check-label custom-option-content" for="customRadioBuilder">
                    <span class="custom-option-body">
                      <i class="mdi mdi-home-city-outline text-body"></i>
              ...
              <div class="col-md mb-md-0 mb-2">
                <div class="form-check custom-option custom-option-icon">
                  <label class="form-check-label custom-option-content" for="customRadioBroker">
                    <span class="custom-option-body">
                      <i class="mdi mdi-briefcase-variant-outline text-body"></i>
              ...
              <div class="col-xl mb-xl-0 mb-2">
                <div class="form-check custom-option custom-option-icon">
                  <label class="form-check-label custom-option-content" for="customRadioSell">
                    <span class="custom-option-body">
                      <i class="mdi mdi-currency-usd text-body"></i>
              ...
              <div class="col-xl mb-xl-0 mb-2">
                <div class="form-check custom-option custom-option-icon">
                  <label class="form-check-label custom-option-content" for="customRadioRent">
                    <span class="custom-option-body">
                      <i class="mdi mdi-wallet-outline text-body"></i>
      ...
      <div id="property-area" class="content">
        <div class="row g-4">
          ...
          <div class="col-sm-6">
            <label class="form-label fw-medium">Possession Status</label>
            <div class="form-check">
          ...
          <div class="col-sm-6">
            <label class="form-label fw-medium">Is Property Facing Main Road?</label>
            <div class="form-check">
          ...
          <div class="col-sm-6">
            <label class="form-label fw-medium">Gated Colony?</label>
            <div class="form-check">
